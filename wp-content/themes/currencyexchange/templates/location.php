...
<section class="location">
    <div class="container">
        <div class="search-section p-4" data-aos="fade-up" data-aos-duration="800">
            <div class="">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 col-2"><select class="form-select w-auto" id="sort-options" data-aos="fade-left" data-aos-duration="800">
                        ...
                        <nav aria-label="Locations pagination">
                            <ul class="pagination custom-pagination justify-content-center align-items-center mb-0">
                                <li class="page-item <?php echo ($current_page <= 1) ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="<?php echo ($current_page > 1) ? esc_url(get_pagenum_link($current_page - 1)) : '#'; ?>">
                                        &laquo; Previous
                                    </a>
                                </li>
                                ...
                                <li class="page-item <?php echo ($current_page >= $total_pages) ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="<?php echo ($current_page < $total_pages) ? esc_url(get_pagenum_link($current_page + 1)) : '#'; ?>">
                                        Next &raquo;
                                    </a>
                                </li>
                            </ul>
